...
export default class CareTakerReg extends Component {
  ...
  handleSubmit(e) {
    ...
    if (!this.state.last_name) {
      return this.setState({ error: '*Second name is required' });
    }
    ...
    return <Fragment>
      ...
      <div className="left">
        <Form onSubmit={this.handleSubmit}>
          <h4>CareTaker Registration</h4>
        
          <div className="login">
            <a onClick={this.handleClick.bind(this)}>
              Or you had already registered? click here
            </a>
          </div>
          {this.state.error && <h5 onClick={this.dismissError}>
            {this.state.error}
          ...
          <div className="sign">
                 <label htmlFor="Upload">Scanned copy of your ID</label><br/>
                  <input type="file" name="Upload_id" required onChange={this.inputIcon.bind(this)}  />
          </div>
          <div className="sign col-md-6">
          ...
          <div className="sign">
                 <label htmlFor="Upload">Upload your passport photo</label><br/>
                  <input type="file" name="Upload_photo" required onChange={this.inputIcon.bind(this)}  />
          </div>
          <div className="sign col-md-6">
