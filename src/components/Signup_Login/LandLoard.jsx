    ...
    return <Fragment>
      ...
      <div className="left">
        <Form onSubmit={this.handleSubmit}>
          ...
          <div className="sign col-md-6">
            <label htmlFor="house">Name of the Apartment/Houses</label>
            <input type="text" name="houses" required value={this.state.houses} onChange={this.handleChange} />
          </div>
          ...
          <div className="sign col-md-6">
            <label htmlFor="location">Location of the Block</label>
            <input type="text" name="location" required value={this.state.location} onChange={this.handleChange} />
          </div>
